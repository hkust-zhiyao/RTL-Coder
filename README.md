...
_**Note**: This repo is under construction. The model, inference scripts, data generation flow and training flow  are provided. The whole dataset will be released upon the acceptance of this paper. 
...
```
We provide a dataset demo with 10 samples in **"data_sample.json"** right now and we will release the whole dataset upon the paper acceptance.
...
```
Please refer the RTLLM benchmark repo https://github.com/NVlabs/verilog-eval to evaluate the generated code quality.
